...
export default function FaqPage() {
  ...
  const items: FaqItem[] = [
    ...
    { category: 'colis',        q: f.q_small_what,         a: f.a_small_what },
    { category: 'colis',        q: f.q_small_price,        a: f.a_small_price },
    { category: 'colis',        q: f.q_small_vs_kg,        a: f.a_small_vs_kg },
    { category: 'colis',        q: f.q_small_availability, a: f.a_small_availability },
