export const en = { 
  ...
  validation: {
    required: 'Required',
    iata_code: '3 letters',
    describe_content: 'Describe the content',
  },
  statuses: { 
  ...
  auth: { 
    ...
    login_section: 'Login details',
    cgu_label: 'I accept the terms and conditions',
    cgu_required: 'Accept the terms and conditions',
    last_name: 'Last name', 
  ...
  booking: { 
    ...
    photos_required: 'At least one parcel photo is required',
  ...
  search: { 
    ...
    filters: 'Filters',
    filter_price_min: 'Min price (€/kg)',
    filter_price_max: 'Max price (€/kg)',
    filter_weight_min: 'Min weight (kg)',
    filter_trust_min: 'Min trust',
    filter_date_max: 'Before',
    filter_reset: 'Reset', 
  ...
  carrierFinance: {
    ...
    payouts_sub: 'Amounts owed and paid to you.',
    payouts_pending: 'Pending',
    payouts_paid: 'Paid',
    payouts_config_warning: 'Set up your payment method to receive your pending earnings.',
    payouts_config_cta: 'Set up',
    payouts_col_amount: 'Amount',
    payouts_col_status: 'Status',
    payouts_status_paid: 'Paid',
    payouts_status_pending: 'Pending',
    payouts_status_failed: 'Failed',
    penalties: 'Penalties',
  ...
  carrier: {
    ...
    airport_required: 'Select airports',
    flight_fields_required: 'Fill in flight and times',
    publish_cta: 'Publish',
  ...
  profile_edit: {
    ...
    payout_section_title: 'Payout method',
    payout_intro: 'How would you like to receive your payments after delivery? Payout is processed automatically 48h after delivery is confirmed.',
    payout_mobile_money: 'Mobile Money',
    payout_bank_transfer: 'Bank transfer',
    payout_phone_label: 'Mobile Money number',
    payout_operator_label: 'Operator',
    payout_iban_label: 'IBAN',
    payout_holder_label: 'Account holder',
  ...
  avis_page: {
    title: 'KIPAR Reviews',
    subtitle: 'What our community thinks of us.',
    loading: 'Loading...',
    load_more: 'See more',
    empty_title: 'No reviews yet',
    empty_subtitle: 'Be the first to share your experience.',
  },
  platform_review: {
    title: 'Your review of KIPAR',
    subtitle: 'Share your experience to help the community.',
    comment_label: 'Your comment (optional)',
    comment_placeholder: 'What did you think of your KIPAR experience?',
    ...
    error_generic: 'An error occurred. Please try again.',
    pending_notice: 'Your review is awaiting moderation.',
  },
  footer: {
  ...
  landing: { 
    ...
    testimonials_see_all: "See all reviews", 
  ...
  publish: {
    tab_sender: 'Send a parcel',
    tab_carrier: 'Offer a trip',
    publish_request_cta: 'Publish my listing',
    publish_trip_cta: 'Publish my trip',
    tip_deadline: 'Date by which the parcel must be delivered to the recipient.',
    tip_mode: 'Per kg: price based on parcel weight. Small parcel: flat rate for a parcel under 1 kg.',
    step_label: 'Step',
    prev_btn: 'Back',
    next_btn: 'Next',
    auth_new: 'New account',
    auth_existing: 'I have an account',
    email_exists_switch: 'This account already exists. Enter your password to log in.',
