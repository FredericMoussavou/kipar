export const fr = {
  ...
  validation: {
    required: 'Requis',
    iata_code: '3 lettres',
    describe_content: 'Décrivez le contenu',
  },
  statuses: {
  ...
  auth: {
    ...
    login_section: 'Identifiants',
    cgu_label: "J'accepte les conditions générales",
    cgu_required: 'Acceptez les conditions générales',
    last_name: 'Nom',
    ...
    reset_email_hint: 'Si un compte existe avec cet email, vous recevrez un lien de réinitialisation valable 15 minutes.',
    back_to_login: 'Retour à la connexion',
    pwd_err_min: 'Le mot de passe doit contenir au moins 8 caractères',
    pwd_err_upper: 'Au moins une majuscule requise',
    pwd_err_digit: 'Au moins un chiffre requis',
    redirect_3s: 'Redirection automatique dans 3 secondes...',
  ...
  booking: {
    ...
    photos_required: 'Au moins une photo du colis est requise',
  ...
  search: {
    ...
    filters: 'Filtres',
    filter_price_min: 'Prix min (€/kg)',
    filter_price_max: 'Prix max (€/kg)',
    filter_weight_min: 'Poids min (kg)',
    filter_trust_min: 'Trust min',
    filter_date_max: 'Avant le',
    filter_reset: 'Réinitialiser',
  ...
  carrierFinance: {
    ...
    period_all: 'Tout (5 ans)',
    rev_collected: 'Revenus encaissés',
    rev_pending: 'En attente (escrow)',
    rev_disputed: 'Bloqués (litige)',
    unit_deliveries: 'livraison(s)',
    unit_in_progress: 'en cours',
    unit_disputes: 'litige(s)',
    chart_title: 'Évolution des revenus',
    payouts_title: 'Mes versements',
    payouts_sub: 'Sommes qui vous sont dues et versées.',
    payouts_pending: 'En attente',
    payouts_paid: 'Versé',
    payouts_config_warning: 'Configurez votre moyen de paiement pour recevoir vos gains en attente.',
    payouts_config_cta: 'Configurer',
    payouts_col_amount: 'Montant',
    payouts_col_status: 'Statut',
    payouts_status_paid: 'Versé',
    payouts_status_pending: 'En attente',
    payouts_status_failed: 'Échec',
    penalties: 'Pénalités',
    penalties_sub: 'Déduites automatiquement de vos prochains versements.',
    balance_due: 'Solde dû',
    col_date: 'Date',
    col_movement: 'Mouvement',
    col_amount: 'Montant',
    col_balance_after: 'Solde après',
    mvt_penalty: 'Pénalité',
    mvt_deduction: 'Déduction',
    fiscal_title: 'Déclaration fiscale — 5 ans',
    fiscal_sub: 'Ces chiffres sont fournis à titre indicatif. Consultez un expert-comptable pour votre déclaration.',
    fiscal_year: 'Année',
    fiscal_gross: 'CA brut',
    fiscal_commission: 'Commission Kipar',
    fiscal_net: 'Net encaissé',
    fiscal_deliveries: 'Livraisons',
    current: 'En cours',
    ...
    next: 'Suivant →',
    tx_col_date: 'Date',
    tx_col_status: 'Statut',
    tx_col_trip: 'Trajet',
    tx_col_content: 'Contenu',
    tx_col_weight: 'Poids',
    tx_col_gross: 'Brut',
    tx_col_commission: 'Commission',
    tx_col_net: 'Net',
    tx_col_rail: 'Rail',
    xls_report_title: 'KIPAR — Relevé financier transporteur',
    xls_period: 'Période',
    xls_commission_rate: 'Taux commission Kipar',
    xls_category: 'Catégorie',
    xls_amount_eur: 'Montant (€)',
    xls_rev_collected: 'Revenus encaissés (net)',
    xls_rev_pending: 'Revenus en attente (escrow)',
    xls_rev_disputed: 'Revenus bloqués (litige)',
    xls_n_delivered: 'Nb livraisons terminées',
    xls_n_progress: 'Nb en cours',
    xls_n_disputes: 'Nb litiges',
    xls_n_cancelled: 'Nb annulations',
    xls_sheet_summary: 'Résumé',
    xls_year: 'Année',
    xls_gross_eur: 'CA brut (€)',
    xls_commission_eur: 'Commission Kipar (€)',
    xls_net_eur: 'Net transporteur (€)',
    xls_n_deliveries: 'Nb livraisons',
    xls_sheet_fiscal: 'Fiscal 5 ans',
    xls_status: 'Statut',
    xls_gross_amount_eur: 'Montant brut (€)',
    xls_currency: 'Devise',
    xls_rail: 'Rail',
    xls_origin: 'Origine',
    xls_destination: 'Destination',
    xls_departure: 'Départ',
    xls_flight: 'Vol',
    xls_content: 'Contenu',
    xls_weight_kg: 'Poids (kg)',
    xls_declared_eur: 'Valeur déclarée (€)',
    xls_delivery_confirmed: 'Livraison confirmée',
  ...
  carrier: {
    ...
    airport_required: 'Sélectionnez les aéroports',
    flight_fields_required: 'Renseignez le vol et les horaires',
    publish_cta: 'Publier',
    ...
    capacity_label: 'Capacité disponible',
    max_per_package_label: 'Max par colis',
    price_per_label: 'Prix par',
  ...
  premium: {
    ...
    hero_subtitle: 'Transportez sans limites',
    ...
    per_month: 'par mois',
    yearly: 'Annuel',
    per_year_detail: 'par an · soit 6,67€/mois',
    ...
    pay_pawapay: 'PawaPay (bientôt disponible)',
    ...
    error_subscribe: 'Erreur lors de la souscription',
    ...
    feat_bookings: 'Réservations illimitées',
    feat_bookings_sub: '3 max en gratuit',
    feat_trips: 'Trajets illimités',
    feat_max2_sub: '2 max en gratuit',
    feat_requests: 'Annonces illimitées',
    feat_photos: '5 photos par colis',
    feat_photos_sub: '2 photos en gratuit',
    feat_scan: 'KiparScan illimité',
    feat_scan_sub: '3 scans/mois en gratuit',
    feat_flight: 'Suivi vol en direct',
    feat_reminder: 'Rappel avant atterrissage',
    feat_export: 'Export finance & fiscal',
    feat_badge: 'Badge Premium & mise en avant',
    feat_reviews: 'Historique avis complet',
    feat_reviews_sub: '5 derniers en gratuit',
    feat_support: 'Support prioritaire (SLA 4h)',
    feat_support_sub: 'Support standard en gratuit',
    feat_unavailable: 'Non disponible en gratuit',
  },
  profile_edit: {
    premium_active: 'Abonnement Premium actif',
    premium_subscribe: 'Passer en Premium',
    premium_manage: 'Gérer mon abonnement',
    premium_unlock: 'Débloquer toutes les fonctionnalités',
    carrier_space: 'Espace transporteur',
    carrier_finances: 'Mes finances',
    carrier_finances_sub: 'Revenus, historique, export fiscal',
    carrier_dashboard: 'Tableau de bord transporteur',
    carrier_dashboard_sub: 'Mes trajets et réservations',
    title: 'Mon compte',
    ...
    payout_section_title: 'Moyen de versement',
    payout_intro: 'Comment souhaitez-vous recevoir vos paiements après livraison ? Le versement est effectué automatiquement 48h après la confirmation de livraison.',
    payout_mobile_money: 'Mobile Money',
    payout_bank_transfer: 'Virement bancaire',
    payout_phone_label: 'Numéro Mobile Money',
    payout_operator_label: 'Opérateur',
    payout_iban_label: 'IBAN',
    payout_holder_label: 'Titulaire du compte',
  ...
  verify: {
    ...
    modal_email_desc: 'Un code à 6 chiffres seront envoyé à votre adresse email.',
    modal_phone_desc: 'Un code à 6 chiffres seront envoyé par SMS à votre numéro.',
  },
  notifications: {
    title: 'Notifications',
  ...
  avis_page: {
    title: 'Avis sur KIPAR',
    subtitle: 'Ce que notre communaute pense de nous.',
    loading: 'Chargement...',
    load_more: 'Voir plus',
    empty_title: 'Aucun avis pour le moment',
    empty_subtitle: 'Soyez le premier a partager votre experience.',
  },
  platform_review: {
    title: 'Votre avis sur KIPAR',
    subtitle: 'Partagez votre experience pour aider la communaute.',
    comment_label: 'Votre commentaire (optionnel)',
    comment_placeholder: 'Qu\'avez-vous pense de votre experience KIPAR ?',
    submit: 'Envoyer mon avis',
    sending: 'Envoi...',
    success: 'Merci ! Votre avis sera publie apres moderation.',
    error_rating: 'Veuillez choisir une note.',
    error_generic: 'Une erreur est survenue. Reessayez.',
    pending_notice: 'Votre avis est en attente de moderation.',
  },
  footer: {
  ...
  landing: {
    ...
    testimonials_see_all: 'Voir tous les avis',
  ...
  publish: {
    tab_sender: 'Envoyer un colis',
    tab_carrier: 'Proposer un trajet',
    publish_request_cta: 'Publier mon annonce',
    publish_trip_cta: 'Publier mon trajet',
    tip_deadline: 'Date avant laquelle le colis doit être livré au destinataire.',
    tip_mode: 'Au kg : tarif selon le poids du colis. Petit colis : forfait fixe pour un colis de moins d\'1 kg.',
    step_label: 'Étape',
    prev_btn: 'Précédent',
    next_btn: 'Suivant',
    auth_new: 'Nouveau compte',
    auth_existing: "J'ai un compte",
    email_exists_switch: 'Ce compte existe deja. Entrez votre mot de passe pour vous connecter.',
  ...
  faq: {
    ...
    a_kyc_rejected: "Si votre KYC est rejeté, verifique que vos documents sont lisibles, non expirés et que le selfie est bien visible. Vous pouvez relancer le processus depuis votre profil. Si le problème persiste, contactez-nous à contact@kipar.app.",
    ...
    a_small_availability: "No. Chaque transporteur choisit ce qu'il accepte : uniquement des colis au kilo, uniquement des petits colis, ou les deux. Vous pouvez filtrer les trajets acceptant les petits colis grâce au filtre dédié dans la recherche.",
